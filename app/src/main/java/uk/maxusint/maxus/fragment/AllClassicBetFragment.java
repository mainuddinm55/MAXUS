 ...
 */
public class AllClassicBetFragment extends Fragment implements MatchBetAdapter.ItemClickListener {
    public static final String TAG = "AllClassicBetFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_all_classic_bet, container, false);
    }
    ...
    private void getAllMatches() {
        disposable.add(
                apiService.getBetRateWithMatchBetGroup(betMode, User.UserType.CLASSIC)
                        ...
                        .subscribeWith(new DisposableSingleObserver<MatchBetRateResponse>() {
                            ...
                            public void onSuccess(MatchBetRateResponse matchBetRateResponse) {
                                if (matchBetRateResponse.getMatches().size() > 0) {
                                    ...
                                    adapter.setItemClickListener(AllClassicBetFragment.this);
                                }
                            }
