...
public class WithdrawActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        historyBundle.putInt(DepositHistoryFragment.ACTION, Transaction.Type.WITHDRAW_HISTORY);
        requestBundle.putInt(DepositRequestFragment.ACTION, Transaction.Type.WITHDRAW_REQUEST);
